...
But then I started working at [large organizations](https://www.nytimes.com) filled with people much smarter than I was, and sharing started to feel uncomfortably self-promotional. And then I landed in a series of [executive roles](https://www.linkedin.com/in/chasejdavis/), and writing about the things I was doing — leadership, strategy, transformation — felt like being the kind of LinkedIn influencer I tend to roll my eyes at.
...
I'm a regular listener of the [Latent Space](https://www.latent.space/) podcast, and one of the hosts, Swyx, has been a yearslong advocate for the value of learning in public. In the world of data journalism and AI, specifically, [Simon Willison](https://simonwillison.net/) is rather famous for this. Longtime friends like [Ben Welsh](https://palewi.re/), [Matt Waite](https://github.com/mattwaite) and [Derek Willis](https://thescoop.org/) have never really stopped.
